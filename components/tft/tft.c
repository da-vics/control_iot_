...
extern uint8_t tft_HachiMaruPop18[];
...
const color_t TFT_DARKGREY    = { 60, 60, 60 };
const color_t TFT_BLUE        = {   0,   0, 255 };
// const color_t TFT_GREEN       = {   0, 255,   0 };
const color_t TFT_GREEN       = {   46, 204,   113 };
...
void TFT_setFont(uint8_t font, const char *font_file)
{
  ...
  if (font == FONT_7SEG) {
    ...
    cfont.color  = _fg;
	  ...
	  else if(font == TestFont) cfont.font = tft_HachiMaruPop18;
